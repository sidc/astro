/* 
  ...
  Krishna_1_Sidereal.c	A program to find Krishna's birthdate according to Chart 1 given in the commentary on Bhagavata Purana (10.3.1) by Srila Sanatana Goswami. This programs uses sidereal astrology. 
