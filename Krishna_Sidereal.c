/* 
  ...
  Krishna_Sidereal.c	A program to find Krishna's birthday according to the description given by the Gosvami's in their commentary on Bhagavata Purana (10.3.1) in the book Vaisnava Tosani. This program used Sidereal astrology with topocentric corrections. 
